  ...
  return (
    <div className="flex flex-col ml-1 mr-1 justify-center items-center min-h-screen bg-black relative px-4">
      ...
      <motion.div 
        ...
        className="z-10 bg-opacity-90 bg-gray-950 p-6 sm:p-8 rounded-lg shadow-2xl border border-yellow-500 w-full max-w-md"
      >
        <h2 className="text-2xl sm:text-3xl font-extrabold text-center text-yellow-400 mb-6">Sign Up</h2>
